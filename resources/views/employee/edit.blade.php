                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            @error ('firstName') <div class="fs-6 text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input class="form-control @error('lastName') is-invalid @enderror" type="text" name="lastName" id="lastName" value="{{ $employee->lastname }}" placeholder="Enter lastName">
                            @error ('lastName') <div class="fs-6 text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @error ('email') <div class="fs-6 text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @error ('age') <div class="fs-6 text-danger">{{ $message }}</div> @enderror
                        </div>
                    </div>
